...
const fr = {
  ...
  events: {
    ...
    menu: {
      ...
      addCategory1518: 'Ajouter catégorie 15-18',
      addCategory1518Open: 'Ajouter catégorie 15-18 / Open',
      addCategoryOpen: 'Ajouter catégorie Open',
  ...
  registration: {
    ...
    hc: 'HC',
    hcTitle: 'Hors concours (résultat conservé mais exclu des classements)',
    teammates: 'Équipiers',
  ...
  relay: {
    ...
    hc: 'HC',
    hcTitle: 'Hors concours — résultat conservé mais exclu des classements; les règles de composition (âge/sexe) ne s\'appliquent plus',
...
const en = {
  ...
  events: {
    ...
    menu: {
      ...
      addCategory1518: 'Add category 15-18',
      addCategory1518Open: 'Add category 15-18 / Open',
      addCategoryOpen: 'Add Open category',
  ...
  registration: {
    ...
    hc: 'EXH',
    hcTitle: 'Exhibition (result kept but excluded from rankings)',
    teammates: 'Teammates',
  ...
  relay: {
    ...
    teamName: 'Team name',
    hc: 'EXH',
    hcTitle: 'Exhibition — result kept but excluded from rankings; composition rules (age/gender) no longer apply',
